								...
								<tbody id="myTable">
									<c:forEach var="info" items="${lopDVServices}">
										...
										<tr id = "tr_${info.maLop}">
											...
											<td class="text-center text-danger"><a href="#myModal${info.maLop}" data-toggle="modal"  id="xoa1_${info.maLop}" style="color:red;cursor: pointer;" class="tim-icons icon-simple-remove"></a></td>
											<!-- Modal HTML -->
												...
												<div class="modal-dialog modal-confirm">
													<div class="modal-content">
														...
														<div class="modal-footer">
															<button id="thoat${info.maLop}" style="margin-left: 100px" type="button" class="btn btn-info" data-dismiss="modal">Thoát</button>
															<button onclick='ajax_xoa_DV("${info.maLop}")' style="margin-right: 100px" type="button" class="btn btn-danger">Xóa</button>
														</div>
													</div>
												</div>
											</div> 
